...
public final class PluginBundleManager {
     ...
     */
    public static final String BUNDLE_EXTRA_STRING_MESSAGE = "com.ADBPlugin.extra.STRING_MESSAGE"; //$NON-NLS-1$
    ...
    public static final String BUNDLE_EXTRA_INT_VERSION_CODE =
            "com.ADBPlugin.yourcondition.extra.INT_VERSION_CODE"; //$NON-NLS-1$

...
object BundleScrubber {
     ...
     * is not mutated.
     *
     * @param intent `Intent` to scrub. This parameter may be mutated if scrubbing is necessary. This
     ...
     *
     * @param bundle `Bundle` to scrub. This parameter may be mutated if scrubbing is necessary. This
     * parameter may be null.
